...
<div>
    ...
    <div class="row indigo-text text-darken-4">
        <div class="col s8">
            <p>Hallo! </p>
            <p>Mein Name ist Katja Rübel. </p>
            <p>Ich bin 28 Jahre alt und wohne zur Zeit in Aachen. hier mach ich eine Ausbildung zur mathematisch-technischen Softwareentwicklerin.</p>
